...
import logo from '../SoucePictur/male_avatar.png'
                    ...
                    <div class="box box-primary">
                        ...
                        <div className="profile-img" id="profileImage" >
                              <label htmlFor="file-input4">
                                 <img src={this.state.image4} class="profile-user-img img-responsive img-circle" style={{opacity: '0.5'}} alt="Profile Image" />
                              </label>
