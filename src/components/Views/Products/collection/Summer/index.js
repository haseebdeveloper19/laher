...
class Summerproduct extends Component {
    constructor(props) {
        super();
        this.state = {
                                                    ...
                                                    <div className="col-md-4 col-lg-4 col-sm-4 col-xs-6 mb-5" key={index} id="main-center" >
                                                        <div className="thumb-wrapper">
                                                            ...
                                                            <div className="product-image">
                                                                ...
                                                                <img className="img-responsive" src={`http://localhost:8000/uploads/${item.media}`} alt="summer" />
                                                            </div>
...
export default connect(mapStateToProps, { registerCartLocal })(Summerproduct)