...
import './style.css'
class Whandmade extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
const mapStateToProps = (state) => ({
    ...
    productdata: state.Product.Products.filter((item) => { return item.Size === 'Handmade Series' }),
...
export default connect(mapStateToProps, { registerCartLocal })(Whandmade)