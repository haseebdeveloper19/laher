...
import './style.css'
class WinterKhaddi extends Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <div className="row">
                            ...
                            { this.state.isShow ? <div className="alert alert-success">Product are added to your cart </div> : null}
                                ...
                                {currentTodos && currentTodos.length ?
                                        // this.state.priceSlect || this.state.filter ?

                                        //     this.props.PriceRanges.map((item, index) => {

                                        //         return (
                                        //             <div className="col-md-4 col-lg-4 col-sm-4 col-xs-6" key={index} id="main-center" >
                                        ...
                                        //                         <img className="img-responsive" src={`https://www.uffabrics.com/uploads/${item.media}`} class />
                                        //                     </div>
                                        ...
                                        //     })
                                        //     :
                                        //     this.state.FindCata && this.state.FindCata.length > 0 ? this.state.FindCata.map((item, index) => {
                                        //         return (
                                        //             <div className="col-md-4 col-lg-4 col-sm-4 col-xs-6" key={index} id="main-center" >
                                        //                 <div className="thumb-wrapper">
                                        //                     <span className="wish-icon float-right"><i className="fa fa-heart-o" /></span>
...
const mapStateToProps = (state) => ({
    ...
    productdata: state.Product.Products.filter((item) => { return item.Size === 'Winter Khaddi'}),
...
export default connect(mapStateToProps, { registerCartLocal })(WinterKhaddi)