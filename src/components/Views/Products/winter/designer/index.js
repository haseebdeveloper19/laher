...
import './style.css'
class Wdesigner extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
const mapStateToProps = (state) => ({
    ...
    productdata: state.Product.Products.filter((item) => { return item.Size === 'Designer Plus'}),

    PriceRanges: state.Product.Price.filter((item) => { return item.Size === 'Designer Plus'}),
