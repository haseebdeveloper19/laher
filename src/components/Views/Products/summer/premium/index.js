...
import './style.css'
class Spremuim extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
const mapStateToProps = (state) => ({
    ...
    productdata: state.Product.Products.filter((item) => { return item.Size === 'Premium Khaddi' }),
    PriceRanges: state.Product.Price.filter((item) => { return item.Size === 'Premium Khaddi' }),
...
export default connect(mapStateToProps, { registerCartLocal })(Spremuim)