...
class SummerKhaddi extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
const mapStateToProps = (state) => ({
    ...
    productdata: state.Product.Products.filter(item => { return item.Size === 'Summer Khaddi' }),
    PriceRanges: state.Product.Price.filter(item => { return item.Size === 'Summer Khaddi' }),
...
export default connect(mapStateToProps, { registerCartLocal })(SummerKhaddi)